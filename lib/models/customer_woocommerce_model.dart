...
CustomerModel customerFromJson(String str) => CustomerModel.fromJson(
  json.decode(str),
);

List<CustomerModel> customersFromJson(dynamic str) => List<CustomerModel>.from(
  (str).map(
    (x) => CustomerModel.fromJson(x),
  ),
);
